    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white p-8 rounded-3xl border border-slate-200 space-y-6 shadow-xl relative">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-heading font-extrabold text-slate-900">Create ShieldAI Account</h1>
          <p className="text-xs text-slate-500">Register for secure AI document screening access</p>
        </div>
